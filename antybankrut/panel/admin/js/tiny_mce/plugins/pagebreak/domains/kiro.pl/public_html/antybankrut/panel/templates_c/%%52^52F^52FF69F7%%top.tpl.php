<?php /* Smarty version 2.6.28, created on 2017-02-22 01:26:46
         compiled from blu/top.tpl */ ?>
<div class="container">
    <div class="site_head">
        <div class="site_head_logo">
            <div class="site_head_logo_left"> <a href="" class="site_head_logo_a">Antybankrut</a>
                <div class="menu_n" id="menu_n"></div>
            </div>
            <div class="site_head_logo_right"> <?php if ($this->_tpl_vars['user_id'] != ""): ?>
                ...
                <div style="width:480px;text-align:right;float:right;">
                    <form action="" method="POST">
                        <table width="420">
                            <tr>
                                <td valign="top">
                                    <input type="text" class="inputt" name="login" placeholder="<?php echo $this->_tpl_vars['lang'][154]; ?>
" style="width:160px;"> </td>
                                <td valign="top">
                                    <input type="password" class="inputt" name="haslo" placeholder="<?php echo $this->_tpl_vars['lang'][155]; ?>
" style="width:160px;"> </td>
                                <td valign="center">
...
" style="" name="login_user"> </td>
                ...
                <div style="width:405px;clear:both;float:right;margin-right:70px;"> <?php if ($this->_tpl_vars['fb_login'] == '1'): ?>
                    <div style="float:left;">
                        <a href="fbc.php?login=fb"><img src="<?php echo $this->_tpl_vars['lang'][425]; ?>
"></a>
                    </div> <?php endif; ?>
                    <div style="float:right;padding-top:5px;"> <a href="register/"><?php echo $this->_tpl_vars['lang'][157]; ?>
</a> | <a href="zapomniane-haslo/"><?php echo $this->_tpl_vars['lang'][158]; ?>
</a> </div>
                </div> <?php endif; ?> </div>
        </div>
    </div>
...
<div> <?php if ($this->_tpl_vars['reklama_j'] <> ""): ?><?php echo $this->_tpl_vars['reklama_j']; ?>
        ...
        <br><?php endif; ?></div> <?php if ($this->_tpl_vars['s_on'] == '1'): ?>
...
" class="input" style="width:260px;"> </td>
                        <td align="left"> <?php echo $this->_tpl_vars['lang'][304]; ?>
...
<?php endif; ?>" name="do" style="width:50px;" class="input"> </td>
                        <td align="left">
...
</option> <?php unset($this->_sections['id']);
...
?> <?php if ($this->_tpl_vars['fcatpodq'][$this->_sections['id']['index']] == '0'): ?>
                                <option value="<?php echo $this->_tpl_vars['fcatidq'][$this->_sections['id']['index']]; ?>
...
</option><?php endif; ?> <?php unset($this->_sections['pid']);
...
?> <?php if ($this->_tpl_vars['fcatidq'][$this->_sections['id']['index']] == $this->_tpl_vars['fcatpodq'][$this->_sections['pid']['index']]): ?>
                                <option value="<?php echo $this->_tpl_vars['fcatidq'][$this->_sections['pid']['index']]; ?>
...
</option><?php endif; ?> <?php endfor; endif; ?> <?php endfor; endif; ?> </select>
                        </td>
                        <td style="padding:6px 0 0 0;">
                            <input type="submit" value="<?php echo $this->_tpl_vars['lang'][424]; ?>
" class="szuk_but" style="width:120px;margin-left:15px;"> </td>
                    </tr>
                </table>
            </div>
        </form>
