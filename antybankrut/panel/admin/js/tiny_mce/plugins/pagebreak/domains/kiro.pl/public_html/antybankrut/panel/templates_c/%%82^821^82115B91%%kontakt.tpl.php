<?php /* Smarty version 2.6.28, created on 2017-02-19 20:36:09
...
<div class="post">
    ...
    <div class="entry">
        <p> <?php echo $this->_tpl_vars['kontaktt']; ?>
 <?php if ($this->_tpl_vars['fk'] == 1): ?>
            <center> <?php echo $this->_tpl_vars['lang'][128]; ?>

                <br />
                <br/> <?php if ($this->_tpl_vars['send'] == 'ok'): ?>
                <div id="ukryj" style="color:green"><b><?php echo $this->_tpl_vars['lang'][129]; ?>
</b></div> <?php endif; ?> <?php if ($this->_tpl_vars['send'] == 'error'): ?>
                <div id="ukryj" style="color:red"><b><?php echo $this->_tpl_vars['lang'][130]; ?>
</b></div>
                <br> <?php endif; ?> <?php if ($this->_tpl_vars['error1'] == 'pemail'): ?>
                <div style="color:red"><b><?php echo $this->_tpl_vars['lang'][131]; ?>
</b></div> <?php endif; ?> <?php if ($this->_tpl_vars['error2'] == 'ppemail'): ?>
                <div style="color:red"><b><?php echo $this->_tpl_vars['lang'][132]; ?>
</b></div> <?php endif; ?> <?php if ($this->_tpl_vars['error3'] == 'pt'): ?>
                <div style="color:red"><b><?php echo $this->_tpl_vars['lang'][133]; ?>
</b></div> <?php endif; ?> <?php if ($this->_tpl_vars['error4'] == 'pw'): ?>
                <div style="color:red"><b><?php echo $this->_tpl_vars['lang'][134]; ?>
</b></div> <?php endif; ?> <?php if ($this->_tpl_vars['error5'] == 'pk'): ?>
...
:</b></td>
                        ...
                        <tr>
                            <td>
                                <input type="text" value="<?php echo $this->_tpl_vars['eemail']; ?>
" name="email" style="width: 390px;" />
                                <br /> </td>
                        </tr>
                        <tr>
...
:</b></td>
                        ...
                        <tr>
                            <td>
                                <textarea name="text" style="width: 390px; height: 140px;"><?php echo $this->_tpl_vars['wemail']; ?>
</textarea>
                                <br /> </td>
                        </tr>
                        <tr>
