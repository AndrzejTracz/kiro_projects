<?php /* Smarty version 2.6.28, created on 2017-02-19 20:35:30
         compiled from blu/footer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'blu/footer.tpl', 15, false),)), $this); ?>
</div>
</div> <?php if ($this->_tpl_vars['g_on'] == '1'): ?>
<div class="box_ogl">
    <h1 class="title"><?php echo $this->_tpl_vars['lang'][422]; ?>
</h1>
    <div style="position: relative; overflow: hidden;height:200px;margin:5px;" id="naj_new"> <?php unset($this->_sections['id']);
...
?> <?php if ($this->_tpl_vars['npr_ii']++%5 == 0): ?>
        <div style="margin:5px;"><?php endif; ?>
...
<?php else: ?>images/bf.jpg<?php endif; ?>"  width="150"></a></td>
                        ...
                        <tr>
                            <td valign="top">
                                <div style="margin:5px;word-wrap: break-word;width:145px;height:30px;"> <a href="ogloszenie/<?php echo $this->_tpl_vars['npart_id'][$this->_sections['id']['index']]; ?>
/<?php echo $this->_tpl_vars['npart_tytuln'][$this->_sections['id']['index']]; ?>
...
</a> </div> <?php if ($this->_tpl_vars['npart_cena'][$this->_sections['id']['index']] <> ""): ?>
                                    <div style="font-weight:bold;float:left;margin-left:5px;"><?php echo $this->_tpl_vars['npart_cena'][$this->_sections['id']['index']]; ?>
 zł</div><?php endif; ?>
            ...
            </div> <?php if ($this->_tpl_vars['npr_i']++%5 == 0): ?></div><?php endif; ?> <?php endfor; endif; ?> </div>
</div>
</div> <?php endif; ?>
<div class="site_footer_all">
    <div class="site_footer">
        ...
        <div class="site_footer_right">&copy; &nbsp;2016 Powered by <a href="//kiro.pl">Andrzej Tracz</a></div>
    </div>
</div>
</div>
<div class="d_info" id="ukryj"></div> <?php $_smarty_tpl_vars = $this->_tpl_vars;
